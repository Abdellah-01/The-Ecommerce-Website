...
if(isset($_GET['view_id'])) {
    ...
    $sql = "SELECT * FROM catagory WHERE sno = $view_id";
...
<td><img src="<?php echo "$row[image]"; ?>" style="width: 10%;"></td>
...
echo $date->format('d M Y'); // Outputs: 03 OCT 2024?></td>
										...
										<td class="action-table-data">
											<div class="edit-delete-action">
												<a class="me-2 p-2" href="category-list.php?view_id=<?php echo $row['sno']; ?>" >
													<i data-feather="edit" class="feather-edit"></i>
												</a>
												<a class="me-2 p-2" href="delete_catagory.php?id=<?php echo "$row[sno]"; ?>">
