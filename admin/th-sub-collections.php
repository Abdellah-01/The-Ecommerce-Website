...
<!-- Variant Row -->    <form method="POST" action="sub_collection.php">
...
$sqsl = mysqli_query($con, "SELECT * FROM sub_featured_collections");
while ($row = mysqli_fetch_array($sqsl)) { 
?><tr>
										<td>
											<label class="checkboxs">
...
<td class="action-table-data">
											<div class="edit-delete-action">
												<a class="me-2 p-2" href="th-edit-sub-collections.php?view_id=<?php echo $row['sno']; ?>" >
													<i data-feather="edit" class="feather-edit"></i>
												</a>
											<a href="delete_sub_collection.php?id=<?php echo $row['sno']; ?>">
