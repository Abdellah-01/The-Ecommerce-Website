									...
									<li><a href="policies.php">Policies</a></li>
													...
													<li class="submenu">
														<a href="javascript:void(0);" class="active subdrop"><i
																...
																Settings</span><span class="menu-arrow"></span></a>
														<ul>
															<li><a href="email-settings.php" class="active">Email</a>
															</li>
										...
										<div class="connected-app-card email-setting d-flex w-100">
											<ul class="w-100">
												<li class="flex-column align-items-start">
													...
													<p>Used to send emails safely and easily via PHP code from a web
														server.</p>
												</li>
												<li>
										...
										<div class="connected-app-card email-setting d-flex w-100">
											<ul class="w-100">
												<li class="flex-column align-items-start">
													...
													<p>SMTP is used to send, relay or forward messages from a mail
														client.</p>
												</li>
												<li>
													<div class="integration-btn">
										...
										<div class="connected-app-card email-setting d-flex w-100">
											<ul class="w-100">
												<li class="flex-column align-items-start">
													...
													<p>Cloud-based email marketing tool that assists marketers and
														developers .</p>
												</li>
												<li>
													<div class="integration-btn">
														<a href="" data-bs-toggle="modal" data-bs-target="#test-mail"><i
																data-feather="tool" class="me-2"></i>View
															Integration</a>
													</div>
													<div
														class="status-toggle modal-status d-flex justify-content-between align-items-center ms-2">
