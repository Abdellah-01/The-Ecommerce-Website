						...
						<div class="table-top table-top-new">
							...
							<div class="search-path d-flex align-items-center search-path-new">
								<div class="d-flex">
									...
									<a href="department-list.php" class="btn-list"><i data-feather="list"
											class="feather-user"></i></a>
									<a href="department-grid.php" class="btn-grid active"><i data-feather="grid"
											class="feather-user"></i></a>
								</div>
								<div class="form-sort">
							...
							<div class="employee-grid-profile">
								...
								<ul class="team-members">
									...
									<li>
										<ul>
											<li>
												<a href="javascript:void(0);"><img src="assets/img/users/user-01.jpg"
														alt=""></a>
											</li>
											<li>
												<a href="javascript:void(0);"><img src="assets/img/users/user-02.jpg"
														alt=""></a>
											</li>
											<li>
												<a href="javascript:void(0);"><img src="assets/img/users/user-03.jpg"
														alt=""></a>
											</li>
											<li>
												<a href="javascript:void(0);"><img src="assets/img/users/user-04.jpg"
														alt=""><span>+4</span></a>
											</li>
										</ul>
									</li>
								...
								<ul class="team-members">
									...
									<li>
										<ul>
											...
											<li>
												<a href="javascript:void(0);"><img src="assets/img/users/user-05.jpg"
														alt=""><span>+3</span></a>
											</li>
								...
								<ul class="team-members">
									...
									<li>
										<ul>
											...
											<li>
												<a href="javascript:void(0);"><img src="assets/img/users/user-06.jpg"
														alt=""></a>
											</li>
											<li>
												<a href="javascript:void(0);"><img src="assets/img/users/user-05.jpg"
								...
								<ul class="team-members">
									...
									<li>
										<ul>
											...
											<li>
												<a href="javascript:void(0);"><img src="assets/img/users/user-09.jpg"
														alt=""></a>
											</li>
											<li>
												<a href="javascript:void(0);"><img src="assets/img/users/user-05.jpg"
