...
<head>
	...
	<!-- Include SweetAlert library (add in <head> or before closing </body>) -->
...
<body>
							...
							<table class="table  datanew">
								...
								<tbody class="sales-list">
									<tr>
										...
										<td>SL0101</td>
										<td>19 Jan 2023</td>
										<td>Recieved Wrong Item</td>
										<td>
											<a href="javascript:void(0);" class="mb-0" onclick="showAlert()">View
												Message</a>
										</td>
										<td>
											<span class="badge badge-bgdanger status-badge">Pending</span>
										</td>
											...
											<ul class="dropdown-menu">
												<li>
													<a href="#" class="dropdown-item update-status"
														data-status="Received" data-class="badges-warning">
														<i data-feather="check-circle" class="info-img"></i> Mark as
														<b>Received</b>
													</a>
												</li>
												<li>
													<a href="#" class="dropdown-item update-status"
														data-status="On Progress" data-class="badges-warning">
														<i data-feather="loader" class="info-img"></i> Mark as <b>On
															Progress</b>
													</a>
												</li>
												<li>
													<a href="#" class="dropdown-item update-status"
														data-bs-toggle="modal" data-bs-target="#Fulfillment"
														data-status="Fulfilled" data-class="badge-bgsuccess">
														<i data-feather="package" class="info-img"></i> Mark as
														<b>Fulfilled</b>
													</a>
												</li>
												<li>
													<a href="#" class="dropdown-item update-status" data-status="Failed"
														data-class="badge-bgdanger">
														<i data-feather="x-circle" class="info-img"></i> Mark as
														<b>Failed</b>
													</a>
												</li>
											</ul>
	...
	<!-- show payment Modal -->
	<div class="modal fade" id="Fulfillment" tabindex="-1" aria-labelledby="Fulfillment" aria-hidden="true">
	...
	<script>
		$(".view-messaage").on("click", function () {
			Swal.fire({
				title: "Are you sure?",
	...
	<script>
		document.querySelectorAll('.update-status').forEach(item => {
			item.addEventListener('click', function (e) {
				...
				// Get the status and class from the clicked item
				const newStatus = this.getAttribute('data-status');
				const newClass = this.getAttribute('data-class');

				// Find the closest row and badge inside it
				const row = this.closest('tr');
				const badge = row.querySelector('.status-badge');

				// Remove existing badge-* classes
				badge.className = 'badge status-badge'; // reset classes
				badge.classList.add(newClass); // add new class
				badge.textContent = newStatus; // update text
			});
		});
	</script>
