						...
						<div class="chat-header">
							...
							<div class="chat-options ">
								<ul class="list-inline">
									...
									<li class="list-inline-item">
										<a href="video-call.php" class="btn btn-outline-light" data-bs-toggle="tooltip"
											data-bs-placement="bottom" title="Video Call">
											<i class="bx bx-video"></i>
										</a>
									</li>
									<li class="list-inline-item">
										<a href="audio-call.php" class="btn btn-outline-light" data-bs-toggle="tooltip"
								...
								<div class="mt-0 right_sidebar_logo">
									<div class="text-center right-sidebar-profile">
										...
										<div class="chat-options chat-option-profile">
											<ul class="list-inline">
												<li class="list-inline-item">
													<a href="audio-call.php" class="btn btn-outline-light "
												...
												<li class="list-inline-item ">
													<a href="video-call.php" class="btn btn-outline-light profile-open"
														data-bs-toggle="tooltip" data-bs-placement="bottom"
														title="Video Call">
														<i class="bx bx-video"></i>
													</a>
