				...
				<div class="page-header">
					...
					<div class="page-btn">
						<a href="#" class="btn btn-added" data-bs-toggle="modal" data-bs-target="#add-units"><i
								data-feather="plus-circle" class="me-2"></i> Add New Warranty</a>
					</div>
				</div>
				<!-- /product list -->
							...
							<table class="table  datanew">
								...
								<tbody>
									<tr>
										...
										<td>
											<p class="description-para">Repairs or a replacement for a faulty product
												within a specified time period after it was purchased.</p>
										</td>
										<td>3 Months</td>
									...
									<tr>
										...
										<td>
											<p class="description-para">Seller of the property(grantor) warrants only
												against anything that occurred during their physical ownership.</p>
										</td>
										<td>6 Months</td>
										<td><span class="badge badge-linesuccess">Active</span></td>
										<td class="action-table-data">
									...
									<tr>
										...
										<td>
											<p class="description-para">Assurances that a product is fit for the purpose
												that it is intended and that it is merchantable.</p>
										</td>
										<td>1 Year</td>
										<td><span class="badge badge-linesuccess">Active</span></td>
										<td class="action-table-data">
								...
								<div class="row">
									...
									<div class="col-lg-12">
										<div class="mb-3 input-blocks">
											<label class="form-label">Description</label>
											<textarea
												class="form-control">Repairs or a replacement for a faulty product within a specified time period after it was purchased.</textarea>
										</div>
									</div>
								</div>
								<div class="mb-0">
