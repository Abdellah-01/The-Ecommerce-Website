		...
		<div class="header">
			...
			<div class="header-left active">
				<a href="index.php" class="logo logo-normal">
					<img src="../website/images/logo/Logo-Black.png" alt="">
				</a>
				...
				<li class="nav-item dropdown has-arrow main-drop select-store-dropdown">
					...
					<div class="dropdown-menu dropdown-menu-right">
						<a href="home.php" class="dropdown-item">
							<img src="assets/img/store/store-01.png" alt="Store Logo" class="img-fluid"> Dashboard
						</a>
						<a href="th-announcement.php" class="dropdown-item">
							<img src="assets/img/store/store-02.png" alt="Store Logo" class="img-fluid"> Customization
						</a>
					</div>
				</li>
				<!-- /Select Store -->
