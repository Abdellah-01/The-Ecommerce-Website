				...
				<div class="row">
					<div class="col-lg-3 col-md-12 sidebars-right theiaStickySidebar section-bulk-widget">
						<aside class="card file-manager-sidebar mb-0">
							...
							<ul class="mb-5">
								<li><a href="file-manager.php" class="active"><span class="me-2 btn-icon"><i
									...
									<div class="detail">
										<a href="javascript:void(0);"
											...
											<span class="d-flex align-items-center justify-content-center"><img
													src="assets/img/icons/folder.svg" alt="Folder"></span>
										</a>
								...
								<div class="col-sm-6 col-md-3">
									<div class="detail">
										<a href="javascript:void(0);"
											...
											<span class="d-flex align-items-center justify-content-center"><img
													src="assets/img/icons/pdf-02.svg" alt="Folder"></span>
										</a>
										<div class="d-flex align-items-center justify-content-between info">
								...
								<div class="col-sm-6 col-md-3">
									<div class="detail">
										<a href="javascript:void(0);"
											...
											<span class="d-flex align-items-center justify-content-center"><img
													src="assets/img/icons/image.svg" alt="Folder"></span>
										</a>
										<div class="d-flex align-items-center justify-content-between info">
								...
								<div class="col-sm-6 col-md-3">
									<div class="detail">
										<a href="javascript:void(0);"
											class="d-flex align-items-center justify-content-center bg-light-red bg p-4">
											<span class="d-flex align-items-center justify-content-center"><img
													src="assets/img/icons/video.svg" alt="Folder"></span>
										</a>
										<div class="d-flex align-items-center justify-content-between info">
								...
								<div class="col-sm-6 col-md-3">
									<div class="detail">
										<a href="javascript:void(0);"
											class="d-flex align-items-center justify-content-center bg-light-orange bg p-4">
											<span class="d-flex align-items-center justify-content-center"><img
													src="assets/img/icons/audio.svg" alt="Folder"></span>
										</a>
										<div class="d-flex align-items-center justify-content-between info">
											...
											<div class="item">
												<div>
													<video width="100" height="100" class="js-player" crossorigin
														playsinline poster="assets/img/file-manager/video1.jpg">
														<source
