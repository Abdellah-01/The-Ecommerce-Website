...
?>
    ...
    <section class="flat-spacing-26 section">
        ...
        <div dir="ltr" class="swiper tf-sw-collection"
            ...
            data-free-mode="true"> <!-- ✅ Added smooth scroll -->
                        ...
                        <div class="collection-item-centered hover-img">
                            <div class="img-style">
                                <a href="products.php?id=<?php echo $row['collection_name']; ?>">
                                    <img class="lazyload"
                                         data-src="../admin/<?php echo $row2['image']; ?>"
                            ...
                            <div class="content">
                                <a href="products.php?id=<?php echo $row['collection_name']; ?>"
                                   class="tf-btn btn-light hover-icon font-poppins">
        ...
        <!-- ❌ Removed the pagination dots to preserve your layout cleanly -->
...
<script>
  document.addEventListener("DOMContentLoaded", function () {
    new Swiper('.tf-sw-collection', {
      slidesPerView: 1,
      spaceBetween: 30,
      freeMode: true,
      freeModeMomentum: true,
      freeModeMomentumRatio: 0.3, // Lower means less slowdown near edges
      freeModeMomentumVelocityRatio: 0.5, // Adjusts momentum speed
      loop: false,
      autoplay: false,
      breakpoints: {
        1024: {
