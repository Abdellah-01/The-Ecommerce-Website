...
?>
                                <div class="swiper-slide">
                                    <p class="top-bar-text fw-5 text_white"><?php echo htmlspecialchars($row['label']); ?> <a
                                            href="<?php echo htmlspecialchars($row['link']); ?>" title="all collection" class="tf-btn btn-line">Shop
