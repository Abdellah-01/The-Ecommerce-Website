    ...
    <div id="wrapper">
        ...
        <div class="tf-page-title style-2">
            <div class="container-full">
                <div class="heading text-center">Return's &amp; Exchange's</div>
            </div>
        </div>
        <!-- /page-title -->
                ...
                <form class="mw-705 mx-auto text-center form-contact" id="contactform"
                    ...
                    <div class="d-flex gap-15 mb_15">
                        ...
                        <fieldset class="w-100">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control usernames" name="username" id="username" required
                    ...
                    <div class="custom-dropdown">
                        ...
                        <div class="dropdown-options">
                            <div data-value="product-1">
                                <img src="images/products/brown.jpg" alt="Product 1">
                                <span>Black Oversized T-Shirt</span>
                            </div>
                            <div data-value="product-2">
                                <img src="images/products/brown.jpg" alt="Product 2">
                                <span>Beige Cargo Trousers</span>
                            </div>
                            <div data-value="product-3">
                                <img src="images/products/brown.jpg" alt="Product 3">
                                <span>White Plain Shirt</span>
                            </div>
                        </div>
                        <select name="product" id="product">
                            <option value="">Select Product *</option>
                            <option value="product-1">Black Oversized T-Shirt</option>
                            <option value="product-2">Beige Cargo Trousers</option>
                            <option value="product-3">White Plain Shirt</option>
                        </select>
                    </div>
                    ...
                    <div class="send-wrap">
                        <button type="submit" class="tf-btn radius-3 btn-fill animate-hover-btn justify-content-center"
                ...
                <div class="mega-menu">
                    <div class="row-demo">
                        ...
                        <div class="demo-item position-relative">
                            <a href="home-personalized-pod.php">
                                <div class="demo-image">
                        ...
                        <div class="demo-item">
                            <a href="home-dog-accessories.php">
                                <div class="demo-image">
                        ...
                        <div class="demo-item">
                            <a href="home-gaming-accessories.php">
                                <div class="demo-image position-relative">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="tf-login-form">
                    <form class="" action="my-account.php" accept-charset="utf-8">
    ...
    <script>
        ...
        document.querySelectorAll('.dropdown-options div').forEach(option => {
            option.addEventListener('click', () => {
                ...
                selected.innerHTML = `<img src="${imgSrc}" alt="Icon"> <span>${text}</span>`;
