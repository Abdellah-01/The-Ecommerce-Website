...
<?php require"toolbar-bottom.php"; ?>
                        ...
                        <div class="tf-product-info-list">
                            ...
                            <div class="tf-product-info-buy-button">
                                <form class="">
                                    ...
                                    <a href="javascript:void(0);"
                                        class="tf-product-btn-wishlist hover-tooltip box-icon bg_white btn-icon-action">
    ...
    <script type="text/javascript" src="js/rangle-slider.php"></script>
    <script type="text/javascript" src="js/wow.min.js"></script>
...
<!-- Mirrored from themesflat.co/html/ecomus/wishlist.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 27 Jan 2025 08:27:33 GMT -->
