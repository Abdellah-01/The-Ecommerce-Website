...
<body class="preload-wrapper">
    ...
    <div id="wrapper">
        ...
        <!-- /page-title -->
        <?php
        include '../admin/dbcon.php'; // Adjust the path if necessary
        ?>
            ...
            <div class="container">
                <div class="tf-grid-layout xl-col-3 tf-col-2">
                    ...
                    while ($row = mysqli_fetch_array($sqsl)) {
                        ...
                        $sql1 = mysqli_query($con, "SELECT * FROM catagory WHERE catagory_name='$collection'");
                        $row2 = mysqli_fetch_array($sql1);
                        $image = htmlspecialchars($row2['image']);
                    ?>
                    <div class="collection-item hover-img">
                        <div class="collection-inner">
                            <a href="products.php?id=<?php echo $collection; ?>" class="collection-image img-style">
                                <img class="lazyload" data-src="../admin/<?php echo $image; ?>"
                                    src="../admin/<?php echo $image; ?>" alt="<?php echo $collection; ?>">
                            </a>
                            <div class="collection-content">
                                <a href="products.php?id=<?php echo $collection; ?>"
