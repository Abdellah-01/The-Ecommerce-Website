<!-- Footer -->
<footer id="footer" class="footer has-all-border has-border-full background-black">
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-md-6 col-12">
                                <div class="footer-col footer-col-1 footer-col-block">
                                    ...
                                    <div class="footer-logo">
                                        <a href="index.php">
                                            <img src="images/logo/logo-white.png" alt="" width="180px">
                                        </a>
                                    </div>
                                    <ul>
                                        <li>
                                            <p>Address: 1234 Fashion Street, Suite 567, <br> Madurai, Tamil Nadu, 605 004</p>
                                        </li>
                                        <li>
                                            <p>Email: <a href="#">Admin@gmail.com</a></p>
                                        </li>
                                        <li>
                                            <p>Phone: <a href="#">(212) 555-1234</a></p>
                                        </li>
                                    </ul>
                                    <a href="contact-1.php" class="tf-btn btn-line">Get direction<i
                            ...
                            <div class="col-xl-3 col-md-6 col-12">
                                <div class="footer-col footer-col-2 footer-col-block">
                                    ...
                                    <li>
                                        <a href="delivery-return.php" class="footer-menu_item"> Returns + Exchanges
                                        </a>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <a href="terms-conditions.php" class="footer-menu_item">Terms &amp;
                                            Conditions</a>
                                    </li>
                                    <li>
                                        <a href="faq-2.php" class="footer-menu_item">FAQ’s</a>
                                    </li>
                                    <li>
                                        <a href="store-locations.php" class="footer-menu_item">Store locator</a>
                                    </li>
                                   <!--  <li>
                            ...
                            <div class="col-xl-3 col-md-6 col-12">
                                <div class="footer-col footer-col-3 footer-col-block">
                                    ...
                                    <ul class="footer-menu-list tf-collapse-content">
                                    <li>
                                        <a href="shop-loadmore.php" class="footer-menu_item">Shirts</a>
                                    </li>
                                    <li>
                                        <a href="shop-loadmore.php" class="footer-menu_item">Pants</a>
                                    </li>
                                    <li>
                                        <a href="shop-loadmore.php" class="footer-menu_item">T-Shirts</a>
                                    </li>
                                    <li>
                                        <a href="shop-loadmore.php" class="footer-menu_item">Tracks</a>
                                    </li>
                                    <li>
                                        <a href="shop-loadmore.php" class="footer-menu_item">Trousers</a>
                                    </li>
                                </ul>
                                </div>
                            </div>
       ...
       style="display: block; color: #ff4949; font-family: 'Albert Sans', sans-serif;
              font-size: 14px; font-weight: 400;"></label>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="footer-bottom-wrap d-flex gap-20 flex-wrap justify-content-between align-items-center">
                                    <div class="footer-menu_item">© <span id="current-year"></span> Abdellah Store. All Rights Reserved</div>
