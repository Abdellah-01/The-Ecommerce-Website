                            ...
                            <div class="">
                                <form class="" id="form-password-change" action="#">
                                    <div class="tf-field style-1 mb_15">
                                        <input class="tf-field-input tf-input" placeholder=" " value="<?php echo "$username"; ?>" type="text"
                                            id="property1" name="user name">
                                        <label class="tf-field-label fw-4 text_black-2" for="property1">First
                                            name</label>
                                    </div>
                                    <div class="tf-field style-1 mb_15">
                                        <input class="tf-field-input tf-input" placeholder=" " value="<?php echo "$email"; ?>"type="text"
                                    ...
                                    <div class="tf-field style-1 mb_15">
                                        <input class="tf-field-input tf-input" placeholder=" " type="email"
                                            id="property3" name="email" value="<?php echo "$mobile"; ?>">
                                        <label class="tf-field-label fw-4 text_black-2" for="property3">Mobile</label>
                                    </div>
...
<!-- Mirrored from themesflat.co/html/ecomus/my-account-edit.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 27 Jan 2025 08:27:07 GMT -->
