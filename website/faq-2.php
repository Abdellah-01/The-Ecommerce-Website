        ...
        <div class="tf-accordion-wrap d-flex justify-content-between">
            <div class="box">
                <div class="tf-accordion-link-list w-100 sticky-top radius-10 border-line">
                    ...
                    <div class="tf-link-item">
                        <a class="d-flex justify-content-between align-items-center" href="contact-1.php">
            ...
            <div class="content">
                ...
                <div class="flat-accordion style-default has-btns mb_60">
                    <div class="flat-toggle active">
                        <div class="toggle-title active">Do you offer international shipping?</div>
                        <div class="toggle-content">
                            <p>Currently, we only ship within the country. However, we are actively working on expanding our services to international customers soon. Stay tuned for updates on our shipping policies.</p>
                        </div>
                    </div>
                    <div class="flat-toggle">
                        <div class="toggle-title">How long does delivery take?</div>
                        <div class="toggle-content">
                            <p>Standard delivery usually takes 5-7 business days, while express delivery takes 2-3 business days. Delivery times may vary based on your location and order volume.</p>
                        </div>
                    </div>
                    <div class="flat-toggle">
                        <div class="toggle-title">Do you offer Cash on Delivery (COD)?</div>
                        <div class="toggle-content">
                            <p>Yes, we offer COD for select locations. You can check the availability of this option at checkout. Please note that COD may not be available for high-value orders.</p>
                        </div>
                    </div>
                    <div class="flat-toggle">
                        <div class="toggle-title">Can I modify or cancel my order?</div>
                        <div class="toggle-content">
                            <p>Orders can be modified or canceled within 24 hours of placement. After this period, processing begins, and changes may not be possible. Please contact our support team for assistance.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="flat-accordion style-default has-btns mb_60">
                    <div class="flat-toggle">
                        ...
                        <div class="toggle-content">
                            <p>We accept various payment methods, including credit/debit cards, net banking, UPI, mobile wallets, and COD for select locations. Please check the payment options at checkout.</p>
                        </div>
                    </div>
                    <div class="flat-toggle">
                        <div class="toggle-title">Is online payment secure?</div>
                        <div class="toggle-content">
                            <p>Yes, we use advanced encryption technology and secure payment gateways to ensure that your transactions are safe and protected against fraud.</p>
                        </div>
                    </div>
                    <div class="flat-toggle">
                        <div class="toggle-title">Do you offer EMI options?</div>
                        <div class="toggle-content">
                            <p>Yes, we offer EMI payment options on select credit cards and through partnered payment gateways. You can check the eligibility and tenure at checkout.</p>
                        </div>
                    </div>
                    <div class="flat-toggle">
                        <div class="toggle-title">Why was my payment declined?</div>
                        <div class="toggle-content">
                            <p>Payments may be declined due to incorrect card details, insufficient balance, or bank restrictions. Please verify your details or try a different payment method.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="flat-accordion style-default has-btns">
                    <div class="flat-toggle">
                        ...
                        <div class="toggle-content">
                            <p>We offer a 7-day return policy for unused items with original packaging and tags. Certain items may not be eligible for returns due to hygiene reasons. Please check our Returns page for details.</p>
                        </div>
                    </div>
                    <div class="flat-toggle">
                        <div class="toggle-title">How do I initiate a return?</div>
                        <div class="toggle-content">
                            <p>To initiate a return, log in to your account and request a return from your order history. You can also contact our support team for further assistance with the return process.</p>
                        </div>
                    </div>
                    <div class="flat-toggle">
                        <div class="toggle-title">When will I receive my refund?</div>
                        <div class="toggle-content">
                            <p>Refunds are typically processed within 5-7 business days after the returned item passes our quality checks. The refund amount will be credited to your original payment method.</p>
                        </div>
                    </div>
                    <div class="flat-toggle">
                        <div class="toggle-title">Do you offer exchanges?</div>
                        <div class="toggle-content">
                            <p>Yes, we offer exchanges for size and color variations. If the requested variant is unavailable, we may offer a refund or store credit. Please initiate an exchange request through your account.</p>
                        </div>
                    </div>
                </div>
            </div>
...
<!-- Mirrored from themesflat.co/html/ecomus/faq-2.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 27 Jan 2025 08:27:04 GMT -->
