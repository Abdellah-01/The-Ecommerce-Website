...
<body class="preload-wrapper">
                    ...
                    <div class="col-lg-3">
                        <div class="wrap-sidebar-account">
                            <ul class="my-account-nav">
                                ...
                                <li><span class="my-account-nav-item active">Wallet</span></li>
                                <li><a href="login.php" class="my-account-nav-item">Logout</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-9">
    <div class="my-account-content account-dashboard">
        <!-- Wallet Balance -->
        <div class="mb_60">
            <div class="wallet-balance-box bg-light p-4 rounded shadow-sm">
        ...
        <div class="wallet-history">
            <h6 class="fw-5 mb_20">Transaction History</h6>
            <ul class="timeline list-unstyled ps-0">
                <li class="mb-3">
                    <div class="d-flex justify-content-between">
                        <span class="fw-bold">Added ₹500</span>
                        <span class="text-muted small">05 May 2025 - 10:30 AM</span>
                    </div>
                    <p class="mb-0 text-secondary">Added via UPI</p>
                </li>
                <li class="mb-3">
                    <div class="d-flex justify-content-between">
                        <span class="fw-bold text-danger">Deducted ₹299</span>
                        <span class="text-muted small">04 May 2025 - 5:15 PM</span>
                    </div>
                    <p class="mb-0 text-secondary">Order #12345</p>
                </li>
                <li class="mb-3">
                    <div class="d-flex justify-content-between">
                        <span class="fw-bold">Added ₹1,000</span>
                        <span class="text-muted small">03 May 2025 - 11:00 AM</span>
                    </div>
