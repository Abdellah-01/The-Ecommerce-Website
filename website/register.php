...
<head>
    <meta charset="utf-8">
    <title>Create Account | Abdellah</title>
            ...
            <div class="container">
                <div class="tf-grid-layout lg-col-2 tf-login-wrap">
                        ...
                        <div id="signup">
                            ...
                            <div>
                                <form class="" id="register-form" action="#" method="post" accept-charset="utf-8"
                                    ...
                                    <div class="mb_20">
                                        <button type="submit"
                                            class="tf-btn w-100 radius-3 btn-fill animate-hover-btn justify-content-center">Sign up</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                    ...
                    <div class="tf-login-content">
                        <h5 class="mb_36">I’m an existing user.</h5>
                        <p class="mb_20">Stay ahead with exclusive early access to sales, plus personalized updates on
                            new arrivals, trends, and promotions. If
                            you wish to opt out, simply click unsubscribe in our emails.</p>
...
<!-- Mirrored from themesflat.co/html/ecomus/register.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 27 Jan 2025 08:39:14 GMT -->
