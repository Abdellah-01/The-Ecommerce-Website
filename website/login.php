        ...
        <section class="flat-spacing-10">
            <div class="container">
                <div class="tf-grid-layout lg-col-2 tf-login-wrap">
                    <div class="tf-login-form" style="padding-bottom: 2t0px;">
                        <div id="recover">
                        ...
                        <div id="login">
                            ...
                            <div>
                                <form class="" id="login-form" action="my-account.php" accept-charset="utf-8">
                                    <div class="tf-field style-1 mb_15">
                                        <input class="tf-field-input tf-input" placeholder="" type="email"
                                            id="property3" name="email">
                                        <label class="tf-field-label fw-4 text_black-2" for="property3">Email *</label>
                    ...
                    <div class="tf-login-content">
                        ...
                        <a href="register.php" class="tf-btn btn-line">Register<i
...
<!-- Mirrored from themesflat.co/html/ecomus/login.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 27 Jan 2025 08:27:33 GMT -->
