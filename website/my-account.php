...
<head>
    <meta charset="utf-8">
    <title>Dashboard | Abdellah</title>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9">
                        <div class="my-account-content account-dashboard">
                            <div class="mb_60">
                                <h5 class="fw-5 mb_20">Hello  <?php echo "$username"; ?>!</h5>
                                <p>
                                    From your account dashboard you can view your <a class="text_primary"
                                        href="my-account-orders.php">recent orders</a>, manage your <a
                                        class="text_primary" href="my-account-address.php">shipping and billing
                                        address</a>, and <a class="text_primary" href="my-account-edit.php">edit your
...
<!-- Mirrored from themesflat.co/html/ecomus/my-account.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 27 Jan 2025 08:27:07 GMT -->
