                        ...
                        <div class="tf-page-cart-checkout">
                            <div class="d-flex gap-10 align-items-center mb_20">
                                <svg xmlns="http://www.w3.org/2000/svg" width="40px" height="40px" viewBox="0 0 24 24" fill="currentColor">
                                    ...
                                    <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 15l-5-5 1.41-1.41L11 13.17l6.59-6.59L19 8l-8 9z"/>
                                </svg>
                                <h5 class="fw-5">Payment Success </h5>
                            </div>
                            <p class="mb_20">Your payment was successful! Thank you for your purchase. Your order is now being processed.</p>
                            <a href="index.php"
