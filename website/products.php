    ...
    <div id="wrapper">
        ...
        <div class="tf-page-title">
            <div class="container-full">
                <div class="row">
                    <div class="col-12">
                        <div class="heading text-center"><?php echo"$_REQUEST[id]"; ?></div>
                        <p class="text-center text-2 text_black-2 mt_5">139 Products</p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div dir="ltr" class="swiper tf-sw-collection" data-preview="5" data-tablet="3" data-mobile="2"
                        ...
                        <div class="swiper-wrapper">
                             ...
                             <?php
                                ...
                                $sqsl=mysqli_query($con, "select * from sub_catagory WHERE catagory_name='$_REQUEST[id]'" );
                                while($category=mysqli_fetch_array($sqsl))
                                {?>
                            <div class="swiper-slide" lazy="true">
                                <div class="collection-item style-2 hover-img">
                                    <div class="collection-inner">
                                        <a href="collection.php?id=<?php echo "$category[sub_catagory_name]"; ?>" class="collection-image img-style">
                                            <img class="lazyload" data-src="../admin/<?php echo "$category[image]"; ?>"
                                                src="../admin/<?php echo "$category[image]"; ?>" alt="collection-img">
                                        </a>
                                        <div class="collection-content">
                                            <a href="collection.php?id=<?php echo "$category[sub_catagory_name]"; ?>"
                                                class="tf-btn collection-title hover-icon fs-15"><span><?php echo "$category[sub_catagory_name]"; ?></span><i
...
<?php } ?>
    ...
    $sqsl=mysqli_query($con, "select * from product WHERE catagory_name='$_REQUEST[id]' order by sno desc" );
     ...
     ?>
                       ...
                       <div class="loadItem card-product grid" data-availability="In stock" data-brand="Ecomus">
                            ...
                            <div class="card-product-info">
                                <a href="product-images-grouped.php?id=<?php echo " $products[product_id]"; ?>" class="title link fw-6">
...
<!-- Mirrored from themesflat.co/html/ecomus/shop-loadmore.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 27 Jan 2025 08:25:58 GMT -->
